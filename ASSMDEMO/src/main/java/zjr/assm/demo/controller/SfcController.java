...
public class SfcController {
    ...
    public @ResponseBody Map<String, Object> deploySfc(HttpServletRequest request){
        ...
        try{
            List<SfcNodeCustom> sfcNodeCustoms = sfcNodeService.getSfcNode(sfcId);
            ...
            Sfc sfc = new Sfc(); sfc.setSfcId(sfcId); sfc.setStatus("working"); sfcService.updateSfcStatus(sfc);
...
//                JSONArray sfcNodes = new JSONArray(); JSONArray sfcLinks = new JSONArray();
                ...
                Sfc sfcInfo = sfcService.getSfcById(sfcId); sfc.put("name",sfcInfo.getSfcName());
